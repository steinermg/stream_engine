...
NETCDF_NONSCI_VARIABLES = [
    ...
    'dcl_controller_end_timestamp',
    'sci_flbb_timestamp',
    'instrument_timestamp',
    'header_timestamp',
    'message_sent_timestamp',
    'datalogger_timestamp',
    'zplsc_timestamp',
    'instrument_start_timestamp',
    'sci_suna_timestamp',
    'zplsc_c_transmission_timestamp',
    'sp_mc_sp_timestamp_microsec_component',
    'sp_nav_navdata_timestamp_microsec_component'
]
...
LAT_PARAM_ID = 1382
LON_PARAM_ID = 1391
INTERP_LAT_PARAM_ID = 8105
INTERP_LON_PARAM_ID = 8106
